      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-20 md:px-10 md:py-32 lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-7">
          <p className="font-mono text-xs uppercase tracking-[0.22em] text-muted">
            <span className="mr-3 inline-block h-2 w-2 translate-y-[-2px] rounded-full bg-accent align-middle" />
            Digital Studio
          </p>
          <h1
            className="mt-8 font-bold tracking-tight text-ink"
            style={{
          ...
          <p className="mt-8 max-w-md text-base leading-snug text-muted md:text-lg">
            A small studio for web, mobile, brand, and 3D — shipped in weeks, not quarters.
          </p>
        </div>
